export default {
    ...
    created() {
        ...
        const movieApiUrl = `https://imdb-api.com/API/AdvancedSearch/k_ky04vr2n?title_type=tv_movie&release_date=1950-01-01,1990-01-01&certificates=us:G&count=100`;
        const seriesApiUrl = `https://imdb-api.com/API/AdvancedSearch/k_ky04vr2n?title_type=tv_series&release_date=1950-01-01,1990-01-01&certificates=us:G&count=100`;
